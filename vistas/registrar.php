...
<div id="login" class="container top-buffer bottom-buffer">
    <section class="col-xs-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
        ...
        <div class="col-md-12 col-xs-12">
            <form class="col-md-12" id="formRegister">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="pwd2" name="pwd2" placeholder="Re-ingresa tu password">
                </div>
                <div class="col-md-3 col-md-offset-9">
                    <div id="btn-registro" class="btn btn-success registro" style="width: 100%;"> Registro </div>
